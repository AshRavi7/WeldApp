    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weld_action_project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspection.project')),
            ],
        ),
        migrations.CreateModel(
            name='weld',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_discipline_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspection.project')),
            ],
        ),
        migrations.CreateModel(
            name='heat_calc',
            fields=[
                ...
                ('heat_calc_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspection.project')),
            ],
        ),
        migrations.CreateModel(
            name='gallery',
            fields=[
                ...
                ('photo_report_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspection.project')),
            ],
        ),
        migrations.AddField(
            model_name='drawing',
