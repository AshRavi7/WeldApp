...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='drawing',
            fields=[
                ('drawing_number', models.CharField(max_length=200, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='project',
            fields=[
                ...
                ('data_perform', models.DateTimeField(default=datetime.datetime(2021, 4, 5, 12, 37, 23, 379139))),
